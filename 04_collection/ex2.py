...
result = [i for i in words if i.find("n") >= 0]     # find는 없으면 -1임 있으면 1 더해짐
...
result = [round(sum(score) / len(score), 2) for score in zip(*scores)]    # round는 반올림
